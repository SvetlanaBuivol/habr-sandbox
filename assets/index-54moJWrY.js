(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function s(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(e){if(e.ep)return;e.ep=!0;const n=s(e);fetch(e.href,n)}})();const d=document.querySelector(".header-dropdown-button");function f(){const t=document.getElementById("dropdown-content");t.style.display=t.style.display==="block"?"none":"block",d.classList.toggle("rotated")}d.addEventListener("click",f);const u=document.querySelector(".my-feed-setting-button");function b(){document.querySelector(".my-feed-menu").classList.toggle("active"),document.querySelector(".icon-my-feed-settings").classList.toggle("rotated")}u.addEventListener("click",b);const h=document.querySelector(".sticky-header-settings-button"),w=document.querySelector(".footer-lang-button"),i=document.querySelector(".settings-modal"),l=document.querySelector(".setting-modal-close-button");function g(){i.style.display="block",l.addEventListener("click",c),window.addEventListener("click",m)}function c(){i.style.display="none",l.removeEventListener("click",c),window.removeEventListener("click",m)}function m(t){t.target===i&&c()}h.addEventListener("click",g);w.addEventListener("click",g);const y=[{img:"https://habrastorage.org/getpro/habr/company/a8a/d05/1a5/a8ad051a528365eeade6c64624231202.png",name:"RUVDS.com",rating:3205.16},{img:"https://habrastorage.org/getpro/habr/company/41b/7dd/fba/41b7ddfba1808f6fef6f498d4928024d.png",name:"Timeweb Cloud",rating:1445.02},{img:"https://habrastorage.org/getpro/habr/company/e9c/ba5/370/e9cba53709ce48cceecee1ffe5925b17.png",name:"Selectel",rating:1351.75},{img:"https://habrastorage.org/getpro/habr/company/70c/a67/cc7/70ca67cc7ecfa889ded9b51efa3e70d3.png",name:"MTC",rating:972.73},{img:"https://habrastorage.org/getpro/habr/company/9ed/c74/6b4/9edc746b484c805ecad1f941b5f7068a.png",name:"VK",rating:882.26},{img:"https://habrastorage.org/getpro/habr/company/7e4/7b8/e31/7e47b8e31d0efe9f398461278a16a357.png",name:"Хабр",rating:680.47},{img:"https://habrastorage.org/getpro/habr/company/9db/3c1/ec0/9db3c1ec02265b8bcbfdfb0d23d8b9f2.jpg",name:"Сбер",rating:668.97},{img:"https://habrastorage.org/getpro/habr/company/2d5/0ed/b57/2d50edb57cf45fa07cc4f39f53b78395.png",name:"OTUS",rating:621.01},{img:"https://habrastorage.org/getpro/habr/company/3a5/515/806/3a5515806f33cd7076d16cd91c9bc9e3.png",name:"FirstVDS",rating:505.95},{img:"https://habrastorage.org/getpro/habr/company/264/1ae/cdd/2641aecdd0c173926fae531b2f73e913.png",name:"ГК ЛАНИТ",rating:421.29}],v=({img:t,name:o,rating:s})=>`
    ...
    `,L=document.querySelector(".aside-best-blogs-list"),k=y.map(v).join("");L.insertAdjacentHTML("beforeend",k);const E=[{title:"Как я случайно сэкономил компании полмиллиона долларов",views:73e3,comments:15,newComments:3},{title:"Press F. Что из мира IT мы потеряли в 2023 году",views:9700,comments:65,newComments:18},{title:"Эксперт показал концепцию GUI современной версии Windows XP, если бы она вышла вместо Windows 11",views:45e3,comments:105,newComments:105},{title:"Как я с 0 поднял свой уровень английского до B2 и подтвердил этот уровень на экзамене IELTS Academic",views:8900,comments:58,newComments:82},{title:"Для Героев III вышло долгожданное полномасштабное обновление — Фабрика. Почему это по-настоящему уникальное явление?",views:38e3,comments:167,newComments:108},{title:"Во что играет Дед Мороз? Тест-подборка новогодних игр",views:38e3,comments:167,newComments:108,label:"Турбо"}],S=t=>t>=1e3?`${(t/1e3).toFixed(1).replace(".0","")}K`:t.toString(),B=(t,o)=>{const{title:s,views:r,comments:e,newComments:n,label:a}=t,p=S(r);if(o<5)return`
        ...
        `},M=document.querySelector(".aside-reading-now-list"),q=E.map((t,o)=>B(t,o)).join("");M.insertAdjacentHTML("beforeend",q);
